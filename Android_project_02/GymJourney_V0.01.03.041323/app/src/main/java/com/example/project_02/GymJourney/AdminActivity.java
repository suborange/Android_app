...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DAO_admin = Room.databaseBuilder(this, AppDatabase.class, AppDatabase.USER_TABLE)
        ...
        button_manageacc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // for now TOAST
                Toast.makeText(AdminActivity.this, "feature coming soon", Toast.LENGTH_LONG).show();
